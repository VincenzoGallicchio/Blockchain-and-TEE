...
def add_gen_psw_parser(subparsers, parent_parser):
    parser = subparsers.add_parser(
        'gen_psw',
        help='generates a password in the enclave',
        parents=[parent_parser])
...
def create_parser(prog_name):
    ...
    add_gen_psw_parser(subparsers, parent_parser)
...
def do_deposit(args):
    ...
    response = client.deposit(args.value, args.psw)
