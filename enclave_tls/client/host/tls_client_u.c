    ...
    char* server_port)
{
    ...
    /* Marshalling struct. */
    launch_tls_client_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.server_name = (char*)server_name;
    _args.server_name_len = (server_name) ? (oe_strlen(server_name) + 1) : 0;
    _args.server_port = (char*)server_port;
    _args.server_port_len = (server_port) ? (oe_strlen(server_port) + 1) : 0;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(launch_tls_client_args_t));
    if (server_name)
        OE_ADD_SIZE(_input_buffer_size, _args.server_name_len * sizeof(char));
    if (server_port)
        OE_ADD_SIZE(_input_buffer_size, _args.server_port_len * sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(launch_tls_client_args_t));
    ...
    _pargs_in = (launch_tls_client_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (server_name)
        OE_WRITE_IN_PARAM(server_name, _args.server_name_len * sizeof(char), char*);
    if (server_port)
        OE_WRITE_IN_PARAM(server_port, _args.server_port_len * sizeof(char), char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             tls_client_fcn_id_launch_tls_client,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (launch_tls_client_args_t*)_output_buffer;
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             tls_client_fcn_id_oe_get_sgx_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             tls_client_fcn_id_oe_get_report_v2_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             tls_client_fcn_id_oe_verify_local_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             tls_client_fcn_id_oe_sgx_init_context_switchless_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_enclave_worker_context_t* context)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             tls_client_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    oe_syscall_flock_ocall_args_t* pargs_in = (oe_syscall_flock_ocall_args_t*)input_buffer;
    oe_syscall_flock_ocall_args_t* pargs_out = (oe_syscall_flock_ocall_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = oe_syscall_flock_ocall(
        pargs_in->fd,
        pargs_in->operation);
...
static oe_ocall_func_t __tls_client_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               __tls_client_ocall_function_table,
               77,
               enclave);
}
